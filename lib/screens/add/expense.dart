...
class _FormState extends ChangeNotifier {
  ...
  void submit(
      ...
      required ExpenseForm form}) async {
    if (initial == null) {
      final _cCurr = await callback.getCategory(form.categoryId);
      if (_cCurr != null) {
...
class AddExpense extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    DataManager callback = Provider.of<DataManager>(context);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              FutureBuilder(
                  future: callback.categories,
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return DropdownButtonFormField(
                        items: dropdownItems(context, snapshot.data),
